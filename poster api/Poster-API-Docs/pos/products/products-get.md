...
| Аргумент | Описание                            |
|----------|-------------------------------------|
| 1-й, id  | ID товара, или массив из ID товаров |

### Ответ

Функция возвращает `Promise`, который вернет объект с результатом выполнения.
В зависимости от первого аргумента вернется один объект или массив объектов типа [Product](/docs/v3/pos/types/product) 
