...
Метод устанавливает extras к заказу. Если в момент установки extras не будет интернет-соединения, 
то extras установится, когда соединение восстановится и синхронизируется на остальные кассы в заведении.  
