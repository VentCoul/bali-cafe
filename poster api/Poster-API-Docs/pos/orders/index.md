...
Методы этого раздела дают возможность получать информацию о заказах на кассе. 
Могут менять открытые заказы и создавать новые. Список доступных методов:
...
- [Poster.orders.setOrderBonus: Установить скидку на заказ, оплаченный внешней системой](/docs/v3/pos/orders/orders-setOrderBonus)
...
- [Poster.orders.sendToKitchen: Отправить бегунок по заказу](/docs/v3/pos/orders/orders-sendToKitchen)
