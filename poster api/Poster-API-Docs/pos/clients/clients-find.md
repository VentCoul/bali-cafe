## clients.find: Найти клиента на кассе  
...
Метод находит существующего клиента на кассе по указаному параметру. Возвращает модель этого клиента [Client](/docs/v3/pos/types/client)
