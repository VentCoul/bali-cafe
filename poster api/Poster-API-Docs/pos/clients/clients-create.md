## clients.create: Создать клиента на кассе
...
Poster.clients.create({
        client: {
            client_sex: 1,
            client_name: "Владимир Иванченко", 
...
Метод создает нового клиента на кассе и возвращает модель этого клиента [Client](/docs/v3/pos/types/client).
