...
В глобально доступном объекте `Poster.environment` хранятся переменные окружения. Они передают в каком приложении запущена касса.
...
| desktop  | Boolean параметр: `true` — приложение запущенно в настольной версии приложения на MacOS, Window  |
