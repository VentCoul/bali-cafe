...
| type        | 1 — онлайн-заказ, 2 — бронирование                             |
| sum         | Сумма заказа                                                   |
...
| price          | Цена товара за единицу. Приходит если цену указали в запросе, в других случаях приходит `null`.              |
...
| currency | ISO код валюты оплаты, должен совпадать с валютой аккаунта, например: UAH — гривна, USD — доллар |
