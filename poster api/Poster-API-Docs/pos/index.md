...
**Платформа на кассе (POS Platform)** — это технология, которая позволяет сторонним разработчикам расширить функциональность кассового решения Poster. 
Используйте платформу на кассе для приложений, с которыми взаимодействует официант или кассир. Например:
...
Приложение на платформе для кассы выполняются на Javascript. 
