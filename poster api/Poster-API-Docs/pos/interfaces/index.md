# interface: Интерфейс вашего приложения

Методы этого раздела дают возможность встраиваться в интерфейс кассы.


- [Poster.interface.popup: Показать всплывающее окно](/docs/v3/pos/interfaces/interface-popup)
- [Poster.interface.closePopup: Закрыть всплывающее окно](/docs/v3/pos/interfaces/interface-closePopup)
