...
1. В вашем [аккаунте разработчика](/login) на странице **Разработка** добавьте аккаунт на котором вы проверяете приложение.
2. Перейдите во вкладку **Приложения → Все приложения** в этом аккаунте. Найдите в списке вашу интеграцию и нажмите **Подключить**.
3. В правом верхнем углу кассы нажмите на **</>**, откроется окно настроек платформы.
4. В окне настроек платформы переключите приложение в режим **Development**.
...
В нативном приложении нажмите **Ctrl + Shift + U**, чтобы открыть консоль.
