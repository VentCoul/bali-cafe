...
Обмен данными с Poster происходит двумя типами запросов:

* **Post** — запрос для изменения или добавления данных. .

* **Get** — запрос для получения существующих данных.
...
```javascript
https://joinposter.com/api/menu.updateProduct?token=687409:4164553abf6a031302898da7800b59fb
