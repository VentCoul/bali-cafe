...
1. **Большие элементы интерфейса.** Официант работает с приложением быстро, он не должен подолгу целиться в кнопку. Рекомендуем не делать элементы интерфейса, кликабельная область у которых меньше 44×44 пикселя.
