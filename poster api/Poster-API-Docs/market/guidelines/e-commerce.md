...
Если у вас свой сайт, мобильное приложение, или чатбот для заказа блюд, настройте получение онлайн-заказов на кассе продаж Poster, и не тратьте время на создание чеков вручную для заказов с сайта. 
Пример идеальной интеграции, конструктор сайтов — [Poster QR](https://joinposter.com/applications/poster-shop-production).

<iframe width="560" height="315" src="https://www.youtube.com/embed/lAG717mK-Bo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

### Подключение

#### Если пишите интеграцию со своим сайтом

Чтобы отправлять заказы с сайта в Poster, понадобится **access_token**.
Скопируйте его в админ-панели Poster во вкладке **Доступ → Интеграции** в поле **Личная интеграция**.

<img src="/img/site/docs/my-site-token.jpg" alt="Токен в админ-панели Poster">


☝️ Не создавайте аккаунт разработчика, если не нужно следить когда заказ приняли или отклонили на кассе

☝️ Синхронизацию меню делать не обязательно. Вы можете один раз вручную проставить каким товарам на вашем сайте соответствуют товары в Poster.

#### Если разрабатываете приложения для маркетплейса Poster

Создайте [приложение в аккаунте разработчика](/docs/v3/market/release) и настройте [авторизацию через oAuth](/docs/v3/start/authApi). Клиент не должен вводить токен вручную.


### Синхронизация меню

Чтобы отправить онлайн-заказ в Poster, необходимо знать соответствие между товаром в вашем магазине и ID товара в Poster.
...
Все эти события можете синхронизировать со своей системой. Например, когда закрыли чек, отправлять клиенту сообщение что его заказ готово.
