...
const url = 'https://joinposter.com/api/finance.getReport
...
visible_pnl | Отображение в отчёте P&L: 0 - не отображать, 1 - отображать.
pnl_group | Группа в P&L. 0 - не отображать, 1 - доход, 2 - расходы, 3 - себестоимость, 4 - после прибыли после налогообложения.
