...
Параметр | Описание
-------- | --------
spot_id | Обязательный параметр, ID заведения в которое придет бронирование
type | Тип заказа: 1 — онлайн-заказ, 2 — бронирование
table_id | Обязательный параметр, ID столика который бронируют
guests_count | Обязательный параметр, количество гостей на которых бронируем столик
...
updated_at | Дата изменения статуса бронирования
