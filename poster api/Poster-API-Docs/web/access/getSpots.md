...
<details open> 
<summary>Приклад запиту</summary>
...
const url = 'https://joinposter.com/api/access.getSpots
...
`GET https://joinposter.com/api/access.getSpots`
...
Внутри параметра `storages` лежит массив, в каждом элементе которого есть параметры:
