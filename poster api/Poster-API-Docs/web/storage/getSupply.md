...
supply_ingredient_sum | Общая сумма поставки по ингредиенту
ingredient_name | Название ингредиента
ingredient_unit | Единица измерения: kg — кг, p — шт, l — л
pack_id | ID фасовки
type | Тип товара: 1 — товар, 2 — произведенная тех. карта, 3 — произведенный полуфабрикат, 8 — модификация товара, 10 — ингредиент 
