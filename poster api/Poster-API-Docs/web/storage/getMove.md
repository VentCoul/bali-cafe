...
ingredient_sum | Стоимость перемещенного ингредиента в гривнах
ingredient_sum_netto | Стоимость перемещенного ингредиента без НДС в гривнах. Возвращается если включена настройка «Считать себестоимость и прибыль нетто»
